...
def build_sum_index_from_uploads(
    ...
    *,
    ...
    """
    Build or load a SummaryIndex for a single uploaded PDF and persist summary vectors to Qdrant.
    """
    embed = build_hf_embeddings(embed_model)
    Settings.embed_model = embed
...
def main():
    ...
    parser.add_argument("--mode", type=str, choices=["summarize", "explain", "teach"], default="summarize", help="Select interaction mode.")
